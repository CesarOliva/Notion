            ...
            <PopoverContent className="w-72" align="end" alignOffset={8} forceMount>
                {initialData.isPublished ? (
                    <div className="space-y-4">
                        ...
                        <div>
                            <Button size="sm" className="w-full text-xs" disabled={isSubmiting} onClick={onUnpublish}>Unpublish</Button>
                        </div>
                    </div>
                ) : (
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <span className="text-sx text-muted-foreground mb-4">Share your work with others</span>
